...
7. **Entrypoints**: `smyth run`, `smyth test`, `smyth bench`, `smyth compile`, `smyth compile-test`, `smyth dump`, `smyth format`, `smyth count` (see AGENTS.md for current implementation)
