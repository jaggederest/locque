...
**Expected Output:**
```
Type error: <unknown>: Variable not in scope: my-functoin
...
**Expected Output:**
```
Type error: <unknown>: Variable not in scope: P.add-natt
  Did you mean: P.add-nat?
```
...
1. ✓ Error messages include source location (currently `<unknown>`)
